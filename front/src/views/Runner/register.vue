<template>
  <div class="home">
    <div class="header">
      ...
      <img class="logo" src="../../assets/logoBlanc.svg" alt="icone de feuille de canabis kawaii" />
      <router-link :to="{ name: 'Connexion Partenaire' }">
        <button class="rounded rounded-right button-runner">Déjà inscrit</button>
      </router-link>
    </div>
    ...
    <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <g class="parallax">
        <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(111, 206, 145, 0.5)" />
        <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(255, 255, 255, 1)" />
        <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(111, 206, 145, 0.7)" />
        <use xlink:href="#gentle-wave" x="48" y="7" fill="rgba(111, 206, 145, 1)" />
      </g>
    </svg>
  </div>
</template>
